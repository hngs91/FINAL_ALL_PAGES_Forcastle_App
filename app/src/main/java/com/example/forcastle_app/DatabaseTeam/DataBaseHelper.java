...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    //method queries database for the 5 times nearest times of the second bus journey to the arrival of the first bus journey
